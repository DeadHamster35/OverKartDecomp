...
// 0x3B80
CenterPathStruct d_course_toads_turnpike_unknown_path[] = {
...
CenterPathStruct d_course_toads_turnpike_track_path[] = {
    { 100, 0, 16, 1 },
    { 100, 0, -3, 1 },
    { 100, 0, -23, 1 },
    { 100, 0, -43, 1 },
...
// 0x79B8
u8 d_course_toads_turnpike_truck1_tire[] = {
...
Gfx d_course_toads_turnpike_dl_18DB8[] = {
    ...
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, d_course_toads_turnpike_truck1_tire),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0x0000, G_TX_LOADTILE, 0, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK,
                G_TX_NOLOD, G_TX_NOMIRROR | G_TX_WRAP, G_TX_NOMASK, G_TX_NOLOD),
    gsDPLoadSync(),
...
// 0x23B68
SEARCHLIST d_course_toads_turnpike_addr[] = {
