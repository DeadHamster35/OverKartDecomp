...
/*
 * The sine and cosine tables overlap, but "#define CosTable (gSineTable +
 * 0x400)" doesn't give expected codegen; gSineTable and CosTable need to
...
#ifdef AVOID_UB
#define CosTable (gSineTable + 0x400)
#else
extern f32 CosTable[];
#endif
