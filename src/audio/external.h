...
void Na_PlyEng_Start(u8);
void NaPlyLandStart(u8, f32);
void func_800C13F0(void);
void Naa_FxmixSet(OSMesg);
f32 Naa_PanSet(u8, u8);
s8 Naa_TuneSet(u8, u8, u8);
s8 Naa_PlaySeParaSet(f32, f32, u8);
f32 Naa_EntryCameraPosWork(u8, u8);
void Naa_CalcCameraPos(u8, u8, u8);
struct Unk_8018EFD8* Naa_Calcdoppler(u8, Vec3f, Vec3f, f32*, u8, u32);
void Naa_CheckCameraPos(Camera*, Vec3s, struct Unk_8018EFD8*);
void Naa_Wpospt_to_Cpospt(Camera*, Vec3f, struct Unk_8018EFD8*);
void Naa_CheckSubTrackPort(void);

Vec3f* Naa_InitApliWork(Vec3f, u32);
void Nai_StartSeqSet(u8);
void Nai_StopSeqSet(void);
void Nai_SeqControl(u8, u8, u8, u16);
void func_800C29B4(u8, u16);

void Nai_SeqGameFrameWork(void);
void NAISeqFlagEntry(u32);
void Nai_SeqBufFlagCheck(u32);
void Nai_GetPlayingSeqFlag(void);
u16 NAIGetPlayingSeqFlag(u8);
void Nai_ClearSeqECheckFlag(u8, u8);
u8 Nai_CheckSeqFlagBuffer2(s32);
void Nai_ClearAllSeqFlag(u8);
void Nai_SetSeqLineVolMove(u8, u8, u8, u8);
void Nai_seq_inter_init(void);

void Nai_seq_inter_init_spec(void);
void Nai_FxSetLockFlag(u16);
void Nai_FxClearBgmMuteFlag(u8);
void NAIFxFlagEntry(u32, Vec3f*, u8, f32*, f32*, s8*);
void Nai_StopBufferFx(u8, struct SoundCharacteristics*);
void Nai_EntryBufferFx(void);
void Nai_FxFlagFree(u8, u8);
void Nai_FxNextPlayCheck(u8);
void Nai_FxNowPlayCheck(u8);

void Nai_StopAllHandleFx(u8);
void Nai_StopAllObjHandleFx2(u8, Vec3f*);
void Nai_StopAllObjHandleFx(u8, Vec3f*);
void Nai_StopAllObjFx(Vec3f*);
void Nai_StopObjFlagFx(Vec3f*, u32);
void Nai_StopFx(u32);
void Nai_FxBufFlagCheck(void);
void Nai_SetFxHandleVolume(u8, u8, u16);
void Nai_FxHandleFrameCheck(u8);
...
void accel_onoff(u8);
void accel_volume(u8);

void engine_freq_set(u8);
void level_volume_set(u8);
void level_freq_set(u8);
void level_sound_trigger(u8);

void make_level_sound_trg(u8);
void goal_routine(u8);

void dive_routine(u8);
void mycar_thunder_okidoki(u8);
void thundered_routine(u8);
void thunder_stop_routine(void);
void kansei_low_stop_routine(void);
void tunnel_kansei_kinshi(void);
void enemy_engine_volume(u8);
void make_sound_program(void);
void playSound(s32);
void NaSeqStart(u16);
void NaFanStart(u16);
void NAMusicVolume(u8);
void NaPlyLevelStart(u8, u32);

void NaPlyLevelStop(u8, u32);
void NAPlyTrgStart(u8, u32);
void NAPlyVoiceStart(u8, u32);
void Na_PlyDash_Start(u8);
void Na_EnmVoice_Start(u8, u32);
void Na_PlyEng_Start(u8);
void Na_PlyEng_Stop(u8);
void NAEnmTrgStart(Vec3f, Vec3f, u32);
void NAEnmTrgStop(Vec3f, s32);
void Na_EnmLevel_Start(u8);
void Na_EnmLevel_Stop(u8);
void NaSceneLevelStart(Vec3f, Vec3f, u32);
void NaSceneLevelStop(Vec3f, u32);
void Na_PauseSet(u8);

void Na_ChangeSoundMode(u8, u8);
void Na_SeMute_Title(void);
void Na_SeMute_Title_Off(void);
void Na_SeMute_Hyoushou(void);
void All_LevelSE_Stop(void);
void Na_SeMute_Goal(u8);
void Na_SeMute_Off(u8);
void Na_PanDeforume(void);
void NA_PlyEcho_On(u8, s8);
void NA_PlyEcho_Off(u8);
void Na_EnmEcho_On(u8, s8);
void Na_EnmEcho_Off(u8);
void NaSeqFadeout(u8);
void Na_SE_Fadeout(u8);
void Na_GoalFanfare_Set(u16, u16);
void Na_Fanfare_Start(u8);
void Na_StarBGM_Start(u8);
void Na_EnmMuteki_Start(u8);
void Na_EnmMuteki_Stop(u8);
void Na_PlyThunder_Start(u8);
void Na_PlyThunder_Stop(void);
void Na_EnmThunder_Start(u8);
void Na_EnmThunder_Stop(s32);
void Na_PlyCrush_Start(u8, f32);
void Na_PlyObake_Start(u8);

void Na_Fourth_Init(void);
void Na_Fourth_Routine(void);
...
extern s32 g_PlayerSurfaceSoundID[4]; // = { 0, 0, 0, 0 };          /* const */
...
extern u8 g_lightningFlagPlayer1[8];  // = { 0, 0, 0, 0, 0, 0, 0, 0 };
...
extern u8 asm_DisableEngineSound[4];
