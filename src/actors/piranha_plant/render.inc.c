 ...
 * @param arg2
 */
void display_pakkun(Camera* arg0, Mat4 arg1, PakkunObject* arg2) {
    UNUSED s32 pad;
    u8* addr;
    ...
    temp_f0 = CheckDisplayRange(arg0->camera_pos, arg2->position, arg0->camera_direction[1], 0, gCameraZoom[arg0 - camera1], 1000000.0f);
    ...
    if (g_courseID == COURSE_MARIO_RACEWAY) {
