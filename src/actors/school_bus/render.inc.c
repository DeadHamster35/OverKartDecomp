 ...
 * @param arg1
 */
void display_bus(Camera* arg0, Object* arg1) {
    UNUSED s32 pad[6];
    Mat4 spC8;
    UNUSED s32 pad2[32];
    f32 temp_f0;

    temp_f0 = CheckDisplayRange(arg0->camera_pos, arg1->position, arg0->camera_direction[1], 2500.0f,
                                gCameraZoom[arg0 - camera1], 9000000.0f);
    if (temp_f0 < 0.0f) {
        return;
    }
    ...
    CreateModelingMatrix(spC8, arg1->position, arg1->angle);
    if (SetMatrix(spC8, 0) != 0) {
