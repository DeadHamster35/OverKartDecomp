...
// unk
typedef struct {
    /* 0x00 */ s32 mode; // Library short+pad; keep s32
    /* 0x04 */ s32 timer;
    /* 0x08 */ s32 total_timer;
    /* 0x0C */ s32 timeend;
    /* 0x10 */ s32 pos[3];
    /* 0x1C */ s8 carmove;
    /* 0x1D */ s8 rank;
    /* 0x1E */ s8 kart; // g_CharacterSelections
} GpResult;
typedef GpResult struct_D_802874D8;
