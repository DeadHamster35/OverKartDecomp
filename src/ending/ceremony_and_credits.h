...
void ev_balloon(CinematicCamera*);
void ev_kartmove(CinematicCamera*);
void win_open(CinematicCamera*);
void win_close(CinematicCamera*);
void credits_gone(CinematicCamera*);
void camDEMO_SE_ThisIsMarioKart(CinematicCamera*);
void camDEMO_SeMute_Hyoushou(CinematicCamera*);
void camDEMO_SE_Congratulations(CinematicCamera*);
void camDEMO_SE_HANABI(CinematicCamera*);
void camDEMO_SE_PUKUPUKU_BIGGER(CinematicCamera*);
void camDEMO_SE_PUKUPUKU_DOWN(CinematicCamera*);
void camDEMO_SE_PUKUPUKU_FIRE(CinematicCamera*);
void camDEMO_SE_DODAI_UP(CinematicCamera*);
void camDEMO_SE_STAR_BURST(CinematicCamera*);
void func_80283A54(CinematicCamera*);
void func_80283A7C(CinematicCamera*);
void camDEMO_SE_BIG_CRUSH(CinematicCamera*);
void camDEMO_SE_Voice(CinematicCamera*);
void camDEMO_PRIZE_A_BGM(CinematicCamera*);
void camDEMO_PRIZE_B_BGM(CinematicCamera*);
void camDEMO_Fourth_Init(CinematicCamera*);
void camDEMO_Fourth_Routine(CinematicCamera*);
void camDEMO_ENDING_BGM(CinematicCamera*);
void camDEMO_ChangeSoundMode_result(CinematicCamera*);
void camDEMO_ChangeSoundMode_ending(CinematicCamera*);
void camDEMO_SE_THE_END(CinematicCamera*);
void DemoFirework_0(CinematicCamera*);
