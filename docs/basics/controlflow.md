...
After boot, the game begins by setting up its four threads; [idle](@ref thread1_idle), [video](@ref mainproc), [audio](@ref audioproc), and the [game loop](@ref gameproc).
...
- init_threads:<br />
  - [idle](@ref thread1_idle), [video](@ref mainproc), [audio](@ref audioproc), [game loop](@ref gameproc)<br />
- [game loop](@ref gameproc):<br />
  - [audio](@ref audioproc)<br />
  - [jumpTo a specific menu or race based on a gameState flag.](@ref initialize_sequence)<br />
  - [profiler](@ref SetGraphCPUTime)<br />
  - [begin_gameframe](@ref begin_gameframe)<br />
  - [readControllers](@ref readControllers)<br />
  - [execute_sequence](@ref execute_sequence)<br />
  - [endDL/vsync](@ref flush_displaylist)<br />
  - [execute_sequence](@ref execute_sequence):<br />
    - switch([gGamestate](@ref gGamestate))<br />
      - [menus](@ref UpdateController) -> switch([menu](@ref KBGNumber)) { // do menu stuff }<br />
      - [race_sequence](@ref race_sequence) -> spaghetti<br />
      - [podium_ceremony](@ref ResultsSequence)<br />
      - [credits](@ref EndingSequence)<br />
- [video](@ref mainproc):<br />
