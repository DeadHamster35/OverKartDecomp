...
The two main variables to concern yourself with are `g_SimpleObjectArray` and `g_DynamicObjects`; the core containers of the two systems.  

@ref g_SimpleObjectArray contains:
```
