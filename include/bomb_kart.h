...
extern s32 bomballocptr[NUM_BOMB_KARTS_MAX];

extern BombKart bom[NUM_BOMB_KARTS_MAX];
extern Collision bom_bump[NUM_BOMB_KARTS_MAX];

// data/data_0DD0A0_1.s
extern BombKartSpawn g_BombTable[NUM_COURSES][NUM_BOMB_KARTS_MAX];
