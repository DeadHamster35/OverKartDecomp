...
extern u8 _overkartSegmentStart[];
extern u8 _overkartSegmentNoloadEnd[];
extern u8 _overkartSegmentRomStart[];
extern u8 _overkartSegmentRomEnd[];
...
#define SEG_OVERKART (uintptr_t) &_overkartSegmentStart[0]
#define SEG_OVERKART_ROM_START (uintptr_t) &_overkartSegmentRomStart[0]
#define SEG_OVERKART_SIZE (size_t) ALIGN16((ptrdiff_t) (&_overkartSegmentNoloadEnd[0] - &_overkartSegmentStart[0]))
#define SEG_OVERKART_ROM_SIZE (size_t) ALIGN16((ptrdiff_t) (&_overkartSegmentRomEnd[0] - &_overkartSegmentRomStart[0]))
...
#define MEMORY_POOL_END (uintptr_t) 0x802578D0
...
#define SEG_OVERKART (uintptr_t) 0x80400000
#define SEG_OVERKART_ROM_START (u8*) &_overkartSegmentRomStart[0]
#define SEG_OVERKART_SIZE (size_t) ALIGN16((ptrdiff_t) (&_overkartSegmentNoloadEnd[0] - &_overkartSegmentStart[0]))
#define SEG_OVERKART_ROM_SIZE (size_t) ALIGN16((ptrdiff_t) (&_overkartSegmentRomEnd[0] - &_overkartSegmentRomStart[0]))
